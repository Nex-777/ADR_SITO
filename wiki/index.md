...
*   **[Database Schema](database_schema.md)** – Database tables, states, and RLS policies on Supabase.
...
*   **[Registration Flow](registration_flow.md)** – Multi-step registration wizard (`portal/registrazione.html`), Italian tax code validation, municipal lookup cascade, and jsPDF document generation.
