...
Added in version **1.01.97** and updated in **1.01.97**:
...
-   *Updated in version **1.01.97** to support dynamic course checkout based on chosen plans (e.g. Strongman e Powerlifting, Ibrido, SCAB).*
...
Aggiunto nella versione **1.01.97**:
...
Aggiunta nella versione **1.01.97**:
