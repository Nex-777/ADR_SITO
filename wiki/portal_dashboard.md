...
Added in version **1.02.03** and updated in **1.02.03**:
...
-   *Updated in version **1.02.03** to support dynamic course checkout based on chosen plans (e.g. Strongman e Powerlifting, Ibrido, SCAB).*
...
Aggiunto nella versione **1.02.03**:
...
Aggiunta nella versione **1.02.03**:
