...
Added in version **1.01.96** and updated in **1.01.96**:
...
-   *Updated in version **1.01.96** to support dynamic course checkout based on chosen plans (e.g. Strongman e Powerlifting, Ibrido, SCAB).*
...
Aggiunto nella versione **1.01.96**:
...
Aggiunta nella versione **1.01.96**:
