...
Added in version **1.02.09** and updated in **1.02.09**:
...
-   *Updated in version **1.02.09** to support dynamic course checkout based on chosen plans (e.g. Strongman e Powerlifting, Ibrido, SCAB).*
...
Aggiunto nella versione **1.02.09**:
...
Aggiunta nella versione **1.02.09**:
