...
Added in version **1.01.90** and updated in **1.01.90**:
...
-   *Updated in version **1.01.90** to support dynamic course checkout based on chosen plans (e.g. Strongman e Powerlifting, Ibrido, SCAB).*
...
Aggiunto nella versione **1.01.90**:
...
Aggiunta nella versione **1.01.90**:
