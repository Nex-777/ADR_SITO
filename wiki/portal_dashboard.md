...
Added in version **1.03.17** and updated in **1.03.17**:
...
-   *Updated in version **1.03.17** to support dynamic course checkout based on chosen plans (e.g. Strongman e Powerlifting, Ibrido, SCAB).*
...
Aggiunto nella versione **1.03.17**:
...
Aggiunta nella versione **1.03.17**:
