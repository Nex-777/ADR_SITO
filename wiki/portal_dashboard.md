...
Added in version **1.02.18** and updated in **1.02.18**:
...
-   *Updated in version **1.02.18** to support dynamic course checkout based on chosen plans (e.g. Strongman e Powerlifting, Ibrido, SCAB).*
...
Aggiunto nella versione **1.02.18**:
...
Aggiunta nella versione **1.02.18**:
