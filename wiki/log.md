...
## [2026-07-20] ingest | Aggiunta delle viste Allenatori, Allievi, Validatori e Binding Account (v1.02.23)
...
## [2026-07-20] ingest | Fix Ordinamento Certificato Medico in Dashboard (v1.02.23)
...
## [2026-07-17] ingest | Separazione Pannelli Event Dashboard e Gestione Presenze (v1.02.23)
...
## [2026-07-17] ingest | Fix RLS select_consiglio_anagrafiche Policy (v1.02.23)
...
- **Versione:** Incrementata la versione a v1.02.23.

## [2026-07-16] ingest | Fix Tag Nidificazione Tab Lista Generale (v1.02.23)
...
## [2026-07-16] ingest | Modifica Profilo Atleta e Registro delle Modifiche (v1.02.23)
...
## [2026-07-16] ingest | Date Eventi Range, Iscrizione Dettagliata JSONB e Viste Direttivi Condizionali (v1.02.23)
...
## [2026-07-16] ingest | Ripristino Visibilità Pulsante Epika e Documenti su Mobile (v1.02.23)
...
- Incrementata la versione globale a `1.02.23`.

## [2026-07-16] ingest | Filtri, Ordinamento e Popolo in Soggetti Iscritti Capogruppo (v1.02.23)
...
## [2026-07-16] ingest | Ottimizzazione Lista Generale (Solo 2026, Filtri e Numerazione) (v1.02.23)
- **HTML/JS (epika.html & epika.js):**
...
## [2026-07-16] ingest | Stato Gruppi Storici e Lista Generale Componenti (v1.02.23)
...
## [2026-07-16] ingest | Reorder Epika Header Navbar to Match Adrenalina Style (v1.02.23)
...
- Incremented global version tag to `v1.02.23`.

## [2026-07-16] ingest | Implementazione Vista Capogruppo (v1.02.23)
...
## [2026-07-16] ingest | Risolve ambiguità Join PostgREST epika_gruppi_storici (v1.02.23)
...
## [2026-07-16] ingest | Fix Syntax Error in creaGruppoStorico (v1.02.23)
...
## [2026-07-16] ingest | Gestione Gruppi Avanzata e Storicizzazione Ruoli (v1.02.23)
- **HTML (epika.html):**
...
## [2026-07-16] ingest | Dashboard Popoli, Bottone Cancella e Fix Tendine Nomine (v1.02.23)
- **HTML (epika.html):**
...
## [2026-07-16] ingest | Pannello Gruppi Storici e Raffinamento Nomine Direttivi (v1.02.23)
- **HTML (epika.html):**
...
## [2026-07-16] ingest | Correzioni SCAB e Nomine Multi-Ruolo Direttivi (v1.02.23)
- **JS (epika.js):**
...
## [2026-07-15] ingest | Spostamento Gestione Allenatori dentro SCAB (v1.02.23)
...
## [2026-07-15] ingest | Patches e Correzioni Sezione Amministratore (v1.02.23)
- **JS (epika.js):**
...
## [2026-07-15] ingest | Sezione Amministratore EPIKA & Sistema SCAB (Fase 1-4) (v1.02.23)
...
## [2026-07-15] ingest | Area Documento Identità + Validazione AI + Fix Dashboard Board Member (v1.02.23)
...
- Incrementato global version tag a `v1.02.23`.

## [2026-07-15] ingest | Remove Epika Banner from Athlete Overview, Fix package.json bumping (v1.02.23)
...
## [2026-07-14] ingest | Add Piceni to Peoples List, Remove Debug Panel and Adrenalina Logo, and Add Version Badge (v1.02.23)
- Removed the Adrenalina logo icon from `portal/epika.html` header as requested.
- Added a stylized version badge (e.g. `Vs. 1.02.23`) next to the "EPIKA" header title using a new CSS class `.epk-version-badge` defined in `portal/epika.css`.
...
## [2026-07-14] ingest | Resolve Infinite Recursion in epika_profili RLS Policy (v1.02.23)
...
## [2026-07-14] ingest | Solve PostgreSQL RLS Incompatibility and SyntaxError in epika.js (v1.02.23)
...
## [2026-07-14] ingest | Add Debug Logger Panel for EPIKA First Access Dropdowns Troubleshooting (v1.02.23)
...
## [2026-07-14] ingest | Classical Antiquity Historical Portal (EPIKA) Portals & Logics (Fase 2-5) (v1.02.23)
...
## [2026-07-14] ingest | Fix Resend API Key Rotation and Email Script Error Reporting (v1.02.23)
...
- Incrementata la versione globale a v1.02.23.

## [2026-07-13] ingest | Remove send-suspended-emails.js Serverless Function to comply with Hobby Limit (v1.02.23)
...
## [2026-07-13] ingest | GitHub Actions Workflow for Sending Suspended Emails (v1.02.23)
...
## [2026-07-13] ingest | Send Out Emails to Suspended Members Endpoint (v1.02.23)
...
## [2026-07-13] ingest | Unified Certificate Expiry Scan, Vercel Auth, Auto-Reactivation and Athlete UI Restriction (v1.02.23)
...
## [2026-07-13] ingest | Tuner Loading Reference Fix & Inline Sticky Preview UI (v1.02.23)
...
## [2026-07-13] ingest | PDF ESM, CSEN Sync Fixes, Association Logo Header & Sticky Preview UI (v1.02.23)
...
## [2026-07-10] ingest | Medical Certificate Overwrite and AI Validation Optimization (v1.02.23)
...
- Incrementata la versione globale del portale a v1.02.23.

## [2026-07-09] ingest | Registration Reorganization & Layout Choice (v1.02.23)
...
## [2026-07-09] ingest | Document Front/Back UI Clarifications (v1.02.23)
...
## [2026-07-09] ingest | Document Front/Back Merging & Compression Release (v1.02.23)
...
## [2026-07-09] ingest | Sandbox Canvas CSP Fetch Fix (v1.02.23)
...
## [2026-07-09] ingest | Document Sandbox for Merging and Compression (v1.02.23)
...
## [2026-07-09] ingest | CSEN Sync RENEWAL_SUBMITTED Fallback Fix (v1.02.23)
...
## [2026-07-09] ingest | Registration Step Crash and Duplicate CF Fixes (v1.02.23)
...
## [2026-07-09] ingest | CSEN PDF Path Resolution on Vercel and Retroactive Recovery (v1.02.23)
...
## [2026-07-09] ingest | Medical Certificate Expiration Validation in CSEN Sync (v1.02.23)
...
## [2026-07-09] ingest | CSEN Provisional Card Number Fix (v1.02.23)
...
## [2026-07-09] ingest | CSEN Sync Debug Diagnostics (v1.02.23)
...
## [2026-07-09] fix | Dossier Certificates Ordering and Format (v1.02.23)
...
## [2026-07-09] ingest | Document Retention and History Management (v1.02.23)
...
## [2026-07-08] ingest | Medical Certificate Expiration Edge-case Fix (v1.02.23)
...
- Incrementata la versione globale del portale e del sito a v1.02.23.

## [2026-07-08] ingest | CSEN PDF Compilation & Vercel Bundle Fix (v1.02.23)
...
## [2026-07-08] fix | Hide sensitive tabs for athlete view context (v1.02.23)
...
## [2026-07-07] fix | Align all website and portal version badges (v1.02.23)
- Allineate tutte le versioni dei file principali del sito (index.html, privacy.html, legal.html) e del portale (dashboard.html, login.html, registrazione.html, pagamento.html, forgot-password.html, reset-password.html e relativi JS) alla versione Vs. 1.02.23.
...
## [2026-07-07] fix | Support Confirm Signup and Invite tokens for first-time password resets (v1.02.23)
...
- Allineate le versioni del portale a Vs. 1.02.23.

## [2026-07-07] fix | Add 60s cooldown to prevent OTP token invalidation on double requests (v1.02.23)
...
## [2026-07-07] fix | Fix Free Event Registration price validation error (v1.02.23)
...
- Allineate tutte le versioni del portale a Vs. 1.02.23.

## [2026-07-07] fix | Robust Fallback for Password Recovery Redirect (v1.02.23)
...
## [2026-07-06] feature | Fix RLS policy on public.atti_adesione to allow board/council members to view all files (v1.02.23)
...
- Bumped application version to Vs. 1.02.23.

## [2026-07-06] feature | Regenerate Debora De Gaetano CSEN PDFs and rename Dossier Socio to Dossier Tesserato (v1.02.23)
...
## [2026-07-06] fix | Deferred OTP token verification to prevent email scanner consumption (v1.02.23)
...
## [2026-07-06] fix | Cross-device password reset and Email Scanner immunity (v1.02.23)
...
- Tutte le versioni del portale allineate a Vs. 1.02.23.
## [2026-07-06] fix | Robust password reset redirect build and link expiration feedback (v1.02.23)
...
- Aligned version badges to Vs. 1.02.23.

## [2026-07-06] fix | Fix password reset authentication check (v1.02.23)
...
- Aligned version badges to Vs. 1.02.23 across all portal files and `package.json`.

## [2026-07-03] feature | Add debounced auto-save with live status feedback to PDF coordinates tuner (v1.02.23)
...
## [2026-07-03] feature | Relocate informative PDF details to page 4 and duplicate signature on all pages (v1.02.23)
...
## [2026-07-03] fix | Enforce explicit block styling and 950px height on PDF iframe (v1.02.23)
...
## [2026-07-03] fix | Enlarge PDF tuner iframe and disable native toolbar margins (v1.02.23)
...
## [2026-07-03] fix | Adjust CSP for Blob PDF rendering and add iframe debugging (v1.02.23)
...
- Bumped version string to Vs. 1.02.23.

## [2026-07-03] feature | Live PDF Tuner & Configurable PDF Coordinates (v1.02.23)
...
- Aligned version badges to Vs. 1.02.23 across all application files.

## [2026-07-04] fix | Fix CSEN Sync Pipeline and Add Monitoring System (v1.02.23)
...
- Versione allineata a **Vs. 1.02.23** su tutti i file del portale.


## [2026-07-03] fix | Fix Stored Procedure Overwrite and Activate Loris Benedetti (v1.02.23)
...
- Incrementata la versione globale dell'applicazione a Vs. 1.02.23.


## [2026-07-03] feature | Custom Causale for Tesseramenti (v1.02.23)
...
- Aligned version badges to Vs. 1.02.23 across index.html, legal.html, privacy.html, dashboard.html, and other portal pages.

## [2026-07-03] feature | Registri visibility, Logiche context and Foto Profilo block (v1.02.23)
...
## [2026-07-02] fix | Spostamento Logiche, Rimozione Quota Ann. e Bypass Presidente (v1.02.23)
...
- Aligned version badges to Vs. 1.02.23 across index.html, dashboard.html, login.html, pagamento.html, and registrazione.html.

## [2026-07-02] feature | System Logics Dashboard & Course Expiry Controls (v1.02.23)
...
## [2026-07-01] feature | Add csen scraper to nightly workflow (v1.02.23)
...
## [2026-07-01] feature | Add reconciliation script to nightly workflow (v1.02.23)
...
## [2026-07-01] feature | Ordinamento di default Quote e Cassa (v1.02.23)
- Set default sort order for "Quote e Cassa" table to sort by Receipt Number descending (highest receipt number first).

## [2026-07-01] feature | Ordinamento di default Contabilità (v1.02.23)
...
## [2026-07-01] feature | Ordinamento colonna Dettagli Ricevuta (v1.02.23)
...
## [2026-07-01] fix | Layout contabilità (v1.02.23)
- Fixed missing closing `</div>` in panel-contabilita header causing layout breaking.

## [2026-07-01] fix | UI e formattazione PDF Ricevute (v1.02.23)
...
## [2026-07-01] feature | Stampa Ricevute e Dossier Socio (v1.02.23)
...
- Bumped version to 1.02.23.

## [2026-07-01] feature | Visual Indicators for CSEN Sync Status (v1.02.23)
...
- Version bumped to 1.02.23.

## [2026-06-30] feature | Integrated 2Captcha Solver for CSEN Sync (v1.02.23)
...
## [2026-06-30] feature | CSEN Active Sync (v1.02.23)
...
## [2026-06-30] fix | Persist Switcher View Context and Default Sort Members Registry (v1.02.23)
...
## [2026-06-30] fix | Fix Stored Procedure Permissions and Improve Payment UX (v1.02.23)
...
- Incrementata versione a Vs. 1.02.23.


## [2026-06-30] fix | Use Absolute Paths for Payment Login Links (v1.02.23)
...
## [2026-06-30] fix | Add Login Redirect Parameter for Payments (v1.02.23)
...
## [2026-06-30] fix | Fix Validate Cert Imports and Add Dashboard Reject Button (v1.02.23)
...
## [2026-06-30] ingest | Flusso Email e Nuova Dashboard Pagamenti (v1.02.23)
...
- Incrementata versione del portale a Vs. 1.02.23.


## [2026-06-30] feature | Add Password Requirements Label to Registration (v1.02.23)
...
## [2026-06-30] fix | Refine Security Alert Interception on Client Side (v1.02.23)
...
## [2026-06-30] fix | Authorize Document Buckets and Fix Manual Certificate Approval (v1.02.23)
...
## [2026-06-30] fix | Correct OTP Expiration Text (v1.02.23)
...
## [2026-06-29] feature | ID Document and CSEN PDFs (v1.02.23)
...
## [2026-06-29] fix | Eventi Columns Database Sync (v1.02.23)
...
- Allineato il numero di versione a `1.02.23` su `dashboard.html`.

## [2026-06-29] fix | Redesign version styling, event titles, and cookie banner logic (v1.02.23)
...
## [2026-06-29] fix | Homepage events, registration CSP & GDPR compliance (v1.02.23)
...
## [2026-06-29] feat | Redesign Home Page (v1.02.23)
...
## [2026-06-29] feat | UI/UX Redesign Landing & Mobile Portal (v1.02.23)
...
## [2026-06-29] feat | Responsabili Dinamici (v1.02.23)
...
- Bumped application version to `1.02.23`.

## [2026-06-29] fix | Responsabili Load and Save Fixes (v1.02.23)
...
## [2026-06-28] feat | Corsi & Eventi Redesign (v1.02.23)
...
## [2026-06-28] feat | Mobile UX Redesign (v1.02.23)
...
## [2026-06-28] fix | Eventi e Responsabili (v1.02.23)
...
## [2026-06-28] fix | Stripe checkout automatic_payment_methods error (v1.02.23)
...
- Bumped application version to `1.02.23` across config files and HTML headers.

## [2026-06-28] ingest | Stripe Multi-Method & Management Fee (v1.02.23)
...
## [2026-06-28] fix | Apple Touch Icons, CSP allowed domains, and Local CSS Compilation (v1.02.23)
...
## [2026-06-28] feat | Mobile Speed & Usability Optimization (v1.02.23)
...
## [2026-06-28] update | Adjust Silver and Gold License Tariffs (v1.02.23)
...
- Unified application versioning settings across all files to version `1.02.23`.
- Bumped application version to `1.02.23`.

## [2026-06-28] update | Update Membership and Card Tariffs (v1.02.23)
...
## [2026-06-26] security | Security Hardening v3 — Short-term fixes (v1.02.23)
...
- Bumped application version to `1.02.23` across all configuration files and HTML headers.

## [2026-06-26] security | Security Hardening v3 — Immediate priority fixes (v1.02.23)
...
## [2026-06-25] fix | Merge duplicate Tito Fabio Paoletti accounts and set correct Codice Fiscale (v1.02.23)
...
## [2026-06-25] fix | Sync 'utenti' table with 'anagrafiche' and set up bidirectional database triggers (v1.02.23)
...
## [2026-06-25] fix | Correct SRI Integrity Hashes & Bump (v1.02.23)
...
## [2026-06-25] security | Security Hardening v2 — Post-Verifica (v1.02.23)
...
- Versione aggiornata a `1.02.23` su tutti i file (16 file modificati totali).

## [2026-06-23] fix | Policy Recursion Fix (v1.02.23)
...
- Allineato il numero di versione a `1.02.23` su `login.html` e `dashboard.html`.
- Bumped application version to `1.02.23`.

## [2026-06-23] fix | Patch Istruttori v2 (v1.02.23)
...
## [2026-06-23] ingest | Istruttori Corsi e Presenze (v1.02.23)
...
## [2026-06-23] fix | Align birth dates and sexes to Codice Fiscale (v1.02.23)
...
## [2026-06-20] fix | CSEN Scraper Manual Trigger & Vercel API (v1.02.23)
...
## [2026-06-20] fix | Fix Board Members display, Soci & Tesserati numbering, and Medical Certificate dates (v1.02.23)
...
## [2026-06-24] feat | Add Course Cancellation and Renewal Buttons (v1.02.23)
...
## [2026-06-20] fix | Fix Registry Refresh After Tesserato Activation (v1.02.23)
...
## [2026-06-20] fix | SQL Functions Multi-role Array Support (v1.02.23)
...
## [2026-06-20] fix | Fix Dashboard Tesserati Activation RPC & Align Versions (v1.02.23)
...
- Unified application versioning settings across all config, landing, and dashboard files to version `1.02.23`.
- Bumped application version to `1.02.23`.
...
## [2026-06-18] fix | Rename dashboard area and enforce single board role (v1.02.23)
...
## [2026-06-18] fix | Exclude board and staff from incomplete registrations (v1.02.23)
...
## [2026-06-18] fix | Athlete Context Theme Override (v1.02.23)
...
## [2026-06-18] ingest | Multi-role implementation & Dashboard Fixes (v1.02.23)
...
## [2026-06-18] update | Separate Corsi & Eventi Dashboard Tabs (v1.02.23)
...
## [2026-06-18] update | Member Portal Certificate Fixes & Segmented Events (v1.02.23)
...
## [2026-06-18] update | Course Subscriptions UI & Version Bump (v1.02.23)
...
## [2026-06-18] update | Member Dashboard Implementation (v1.02.23)
...
## [2026-06-18] update | Animated OTP Loading Indicator & Version Bump (v1.02.23)
...
## [2026-06-17] update | Admin Alert Banner Role Isolation (v1.02.23)
...
## [2026-06-17] update | Subdomain Portal Migration, CORS & Stripe Hardening (v1.02.23)
...
- Bumped application version to `1.02.23` across all pages and configurations.
...
## [2026-06-02] fix | Registration Retry Crash & Storage RLS Update Policies (v1.02.23)
...
## [2026-06-02] update | Registry Restructuring & Dashboard UI (v1.02.23)
...
## [2026-06-02] release | Gapless Registry & Dashboard Fixes (v1.02.23)
- Finalized registry restructure, dashboard UI, and security fixes.
- Bumped application version to `1.02.23`.

## [2026-06-02] fix | Registration ON CONFLICT trigger error (v1.02.23)
...
## [2026-06-02] fix | Registration redundant trigger & Date Validation (v1.02.23)
...
## [2026-06-02] fix | OTP Verify API Upsert Error (v1.02.23)
...
## [2026-06-02] feature | Ghost Users Cleanup (v1.02.23)
...
## [2026-06-02] fix | Dashboard JS Syntax Error (v1.02.23)
...
## [2026-06-02] fix | Registrazione Browser Autofill Bug (v1.02.23)
...
## [2026-06-02] feature | AI Certificate Validation & Missing Cert Bugfix (v1.02.23)
...
## [2026-06-02] hotfix | Fix certificati_medici insertion crash (v1.02.23)
...
## [2026-06-02] hotfix | Fix Gemini SDK parsing & Dashboard manual approval (v1.02.23)
...
## [2026-06-02] update | Dashboard UI improvement (v1.02.23)
...
## [2026-06-17] hotfix | Fix dashboard registration approvals list refresh after deletion (v1.02.23)
...
## [2026-06-18] edit | Role-based CSS Theme (v1.02.23)
...
## [2026-06-18] edit | Context Switcher (v1.02.23)
...
## [2026-06-24] fix | Webhook Database and RLS Fix (v1.02.23)
...
## [2026-06-24] edit | Medical Certificate Display (v1.02.23)
- Replaced textual color strings ('VERDE', 'GIALLO', 'ROSSO') with expiration date in instructor view for medical certificates.
- Bumped application version to 1.02.23.

## [2026-06-24] fix | Critical Security Remediation & Key Rotation (v1.02.23)
...
## [2026-06-25] fix | High and Medium Security Hardening (v1.02.23)
...
## [2026-06-26] update | Medium-Term Security & UI Tasks (v1.02.23)
...
- Bumped application version to 1.02.23 across the codebase.
...
## [2026-06-28] style | Improve Version Badge Legibility (v1.02.23)
...
## [2026-06-28] style | Fix Version Badge Legibility & Cache-Control (v1.02.23)
- Fixed a regex replacement error that skipped HTML files in the previous version bump.
- Bumped application version to 1.02.23 across all HTML and JS files.

## [2026-07-02] feat | Expiration Progress Bars for Instructor Dashboard (v1.02.23)
...
- Bumped application version to 1.02.23 across all files.

## [2026-07-02] fix | Mermaid diagram syntax (v1.02.23)
- Wrapped node labels containing special characters in quotes to fix the syntax error in the System Logics diagram.
- Bumped application version to 1.02.23.

## [2026-07-02] fix | Expiration progress bar inline styling (v1.02.23)
...
## [2026-07-02] feat | Tasto Partecipanti per Amministratori (v1.02.23)
...
## [2026-07-02] feat | Expiration progress bar in Registro Tesserati (v1.02.23)
...
## [2026-07-02] feat | Registri CSEN Istruttori e Volontari (v1.02.23)
...
## [2026-07-02] fix | Resolve CSP Block on Domain Change (v1.02.23)
