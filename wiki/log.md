...
## [2026-07-09] ingest | Document Front/Back UI Clarifications (v1.01.71)
...
- Incrementata la versione globale a v1.01.71.

## [2026-07-09] ingest | Document Front/Back Merging & Compression Release (v1.01.71)
...
## [2026-07-09] ingest | Sandbox Canvas CSP Fetch Fix (v1.01.71)
...
## [2026-07-09] ingest | Document Sandbox for Merging and Compression (v1.01.71)
...
## [2026-07-09] ingest | CSEN Sync RENEWAL_SUBMITTED Fallback Fix (v1.01.71)
...
## [2026-07-09] ingest | Registration Step Crash and Duplicate CF Fixes (v1.01.71)
...
## [2026-07-09] ingest | CSEN PDF Path Resolution on Vercel and Retroactive Recovery (v1.01.71)
...
## [2026-07-09] ingest | Medical Certificate Expiration Validation in CSEN Sync (v1.01.71)
...
## [2026-07-09] ingest | CSEN Provisional Card Number Fix (v1.01.71)
...
## [2026-07-09] ingest | CSEN Sync Debug Diagnostics (v1.01.71)
...
## [2026-07-09] fix | Dossier Certificates Ordering and Format (v1.01.71)
...
## [2026-07-08] ingest | Medical Certificate Expiration Edge-case Fix (v1.01.71)
...
- Incrementata la versione globale del portale e del sito a v1.01.71.
