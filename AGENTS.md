...
5. **Versioning Rule**: Whenever you push code to GitHub (`git push`), you MUST increment the application version number in the HTML/JS headers by 1 (e.g. from 1.00.14 to 1.00.15) and explicitly inform the user of the newly pushed version. This is a golden rule to guarantee the user is testing the correct codebase.
